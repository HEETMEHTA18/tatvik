...
class _StudioScreenState extends State<StudioScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Studio', style: GoogleFonts.outfit(fontSize: 40, fontWeight: FontWeight.w800, color: AppTheme.textMain, letterSpacing: -1)),
  ...
  Widget _buildPageNav(BuildContext context) {
    final pages = [
      ...
      ('Studio', Icons.build_circle_rounded, true, const StudioScreen()),
