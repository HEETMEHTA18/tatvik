...
async def generate_tailored_resume(
    ...
    prompt = (
        ...
        "1. The very first line MUST be `# [Candidate Full Name]`.\n"
        "2. The second line MUST be `[Job Title]`.\n"
        "3. The third line MUST be contact info separated by ` | ` (e.g., `Email | City, State | github.com/username | linkedin.com/in/username`). Do NOT use markdown links `[text](url)` here, just raw text.\n"
        "4. Use exactly `## SUMMARY`, `## EXPERIENCE`, `## PROJECTS`, `## SKILLS`, and `## EDUCATION` for section headers.\n"
        "5. Do NOT use markdown links `[text](url)` anywhere in the resume, use plain URLs if necessary.\n\n"
